...
/* 
value1과 value2와 value3 를 기능 바깥에 작성을 하면 안되는 이유
...
function plus() { //plus() 버튼을 누르면 input 안에 작성한 값을 새로 가져오기를 실행
  const value1 = number1.value; //plus() 버튼을 눌럿을 때 input에서 사용자가 작성한 값을 가져오기
  const value2 = number2.value; 
  const value3 = number3.value; 

  console.log("=====puls기능 들어오고 난 후=====");
console.log("값1+"+value1);
console.log("값2+"+value1);
console.log("값3+"+value1);
