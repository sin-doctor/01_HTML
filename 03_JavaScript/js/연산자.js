...
function 더하기() {
  ...
  /* 
                ->input 에서 type을 number로 설정해줘도 input 태그안에서 작성된 값은
                무조건 글자형식 type = number 는 가다다 abc와 같은 문자작성을 못하게 막아주는 역할을 한 뿐
                ...
                예 ) 123 이 있다면 Number(123) 작성하면 됨
                밑에서는 Number(숫자1.value)

                /* 두 수의 함을 아이디가 계산결과인 요소에 내부글자(innerText)로 넣어주기*/
